...
class PoliticsNewsPage extends StatefulWidget {
  const PoliticsNewsPage({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _PoliticsNewsPageState createState() => _PoliticsNewsPageState();
}

class _PoliticsNewsPageState extends State<PoliticsNewsPage> {
  String? data;
  var news_length;
