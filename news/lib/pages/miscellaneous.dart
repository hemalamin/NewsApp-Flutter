...
class MiscellaneousNewsPage extends StatefulWidget {
  const MiscellaneousNewsPage({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _MiscellaneousNewsPageState createState() => _MiscellaneousNewsPageState();
}

class _MiscellaneousNewsPageState extends State<MiscellaneousNewsPage> {
  String? data;
  var news_length;
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
            title: const Text("Miscellaneous News"),
