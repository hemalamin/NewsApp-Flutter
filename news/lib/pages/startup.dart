...
class StartupNewsPage extends StatefulWidget {
  const StartupNewsPage({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _StartupNewsPageState createState() => _StartupNewsPageState();
}

class _StartupNewsPageState extends State<StartupNewsPage> {
  String? data;
  var news_length;
