...
class AutomobileNewsPage extends StatefulWidget {
  const AutomobileNewsPage({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _AutomobileNewsPageState createState() => _AutomobileNewsPageState();
}

class _AutomobileNewsPageState extends State<AutomobileNewsPage> {
  String? data;
  var news_length;
